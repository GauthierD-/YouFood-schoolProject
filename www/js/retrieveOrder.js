    ...
    $.ajax({
        ...
        success: function(result) {
            navigator.notification.alert(
                'Votre commande a bien été enregistrée sous le numéro de transaction : '+evt.transactionID+'.',  // message
                 emptyCart,    // callback
                'YouFoodInc.', // title
                'OK'           // buttonName
            );
