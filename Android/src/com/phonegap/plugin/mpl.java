...
// TBD: list of invoice items
	...
	public void setPaymentInfo(String str) {
		...
		try {
			...
			Log.d("YouFoodLog", mpjs_mpl.mpjs_subtotal);
		} catch (JSONException e) {
			Log.d("YouFoodLog", "erreur total");
			throw new RuntimeException(e);
		}
		try {
			mpjs_mpl.mpjs_currency = obj.getString("paymentCurrency");
			Log.d("YouFoodLog", mpjs_mpl.mpjs_currency);
		} catch (JSONException e) {
			Log.d("YouFoodLog", "erreur currency");
			throw new RuntimeException(e);
		}
		try {
			mpjs_mpl.mpjs_recipient = obj.getString("recipient");
			Log.d("YouFoodLog", mpjs_mpl.mpjs_recipient);
		} catch (JSONException e) {
			Log.d("YouFoodLog", "erreur recipient");
			throw new RuntimeException(e);
		}
		try {
			mpjs_mpl.mpjs_description = obj.getString("itemDesc");
			Log.d("YouFoodLog", mpjs_mpl.mpjs_description);
		} catch (JSONException e) {
			Log.d("YouFoodLog", "erreur desc");
			throw new RuntimeException(e);
		}
		try {
			mpjs_mpl.mpjs_merchantName = obj.getString("merchantName");
			Log.d("YouFoodLog", mpjs_mpl.mpjs_merchantName);
		} catch (JSONException e) {
			Log.d("YouFoodLog", "erreur name");
			throw new RuntimeException(e);
		}
