...
function setPaymentInfoForm(amount, myMerchantName, myRecipient, myItemdesc, currency) {
    var obj = {};

    obj.paymentAmount = amount;
    obj.paymentCurrency = currency;
    obj.recipient = myRecipient;
    obj.merchantName = myMerchantName;
    obj.itemDesc = myItemdesc;
